...
namespace BigShop.Data.Infrastructure
{
    public abstract class RepositoryBase<T> where T : class
    {
        ...
        private BigShopDbContext dataContext;
        ...
        protected BigShopDbContext DbContext
        {
        ...
        public virtual IEnumerable<T> GetMany(Expression<Func<T, bool>> where, string inclues)
        {
        ...
        {
            //HANDLE INCLUDES ASSOCIAT4ED OBJECTS IF APPLICABLE
